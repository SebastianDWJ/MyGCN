...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--hgc', type=int, default=256, help='hidden units of gconv layer')
        parser.add_argument('--lg', type=int, default=6, help='number of gconv layers')
        parser.add_argument('--lr', default=0.002, type=float, help='initial learning rate')
        parser.add_argument('--wd', default=5e-4, type=float, help='weight decay')
        parser.add_argument('--num_iter', default=600, type=int, help='number of epochs for training')
        parser.add_argument('--edropout', type=float, default=0.3, help='edge dropout rate')
        parser.add_argument('--dropout', default=0.4, type=float, help='ratio of dropout')
